        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                Listener(
                    onPointerDown: (_) => game.dash
                        .handleControlButtonPress(DashDirection.left, true),
                    onPointerUp: (_) => game.dash
                        .handleControlButtonPress(DashDirection.left, false),
                    child: Image.asset(
                        'assets/images/jump_n_jump/left_button.png'),
                    key: const Key('leftControlButton')),
                Listener(
                  onPointerDown: (_) => game.dash
                      .handleControlButtonPress(DashDirection.right, true),
                  onPointerUp: (_) => game.dash
                      .handleControlButtonPress(DashDirection.right, false),
                  child:
