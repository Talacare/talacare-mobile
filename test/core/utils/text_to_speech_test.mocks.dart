...
// in talacare/test/core/utils/text_to_speech_test.dart.
...
class MockFlutterTts extends _i1.Mock implements _i2.FlutterTts {
  ...
  @override
  set initHandler(_i3.VoidCallback? _initHandler) => super.noSuchMethod(
        Invocation.setter(
          #initHandler,
          _initHandler,
        ),
  ...
  @override
  void setInitHandler(_i3.VoidCallback? callback) => super.noSuchMethod(
        Invocation.method(
          #setInitHandler,
          [callback],
        ),
