...
void main() {
  ...
  group('DraggablePuzzlePiece Tests', () {
    testWidgets('DraggablePuzzlePiece Load All Component',
    ...
    testWidgets('DraggablePuzzlePiece Can Drag Puzzle',
        (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Column(
          children: [draggablePuzzlePiece, const Text('halo sayang')],
        ),
      ));
      ...
      final Offset secondLocation = tester.getCenter(find.byType(Text));
