...
void main() {
  ...
  testWidgets('Verify the Jump n Jump GameCard is working and navigate to Jump n Jump Page', (tester) async {
  ...
  testWidgets('Verify the Puzzle GameCard is working and navigate to Puzzle Page', (tester) async {
    final mockObserver = MockNavigatorObserver();
